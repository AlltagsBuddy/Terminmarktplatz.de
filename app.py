...
def sitemap():
    ...
    static_priority: list[tuple[str, float]] = [
        ...
        ("/blog/2026-05-25-stornierung-kosten", 0.8),
        ("/blog/2026-06-01-friseur-kurzfristig", 0.8),
        ("/blog/2026-06-08-therapeut-spontan", 0.8),
        ("/blog/2026-06-15-last-minute-termine", 0.8),
        ("/blog/2026-06-22-handwerker-terminluecken", 0.8),
        ("/blog/2026-06-29-wellness-spontan-buchen", 0.8),
        ("/blog/2026-07-06-terminmarktplatz-anbieter", 0.8),
        ("/blog/2026-07-13-dsgvo-online-terminbuchung", 0.8),
        ("/blog/2026-07-20-no-show-vermeiden-tipps", 0.8),
...
if _html_enabled():
    ...
    BLOG_ARTICLES = [
        ...
        {
            "slug": "2026-08-03-online-buchung-kleine-betriebe",
            "title": "Warum Online-Buchung unverzichtbar ist",
            "description": "Online-Buchung für kleine Betriebe: Warum sie unverzichtbar ist.",
            "tag": "Für Anbieter",
            "publish_date": date(2026, 8, 3),
            "reading_time": "5 Min",
        },
        {
            "slug": "2026-07-27-auslastung-verbessern",
            "title": "Auslastung verbessern: 5 Tipps",
            "description": "Auslastung verbessern: 5 praxiserprobte Tipps für Dienstleister.",
            "tag": "Für Anbieter",
            "publish_date": date(2026, 7, 27),
            "reading_time": "5 Min",
        },
        {
            "slug": "2026-07-20-no-show-vermeiden-tipps",
            "title": "No-Show vermeiden: Was Dienstleister tun können",
            "description": "No-Show vermeiden: Erinnerungen, Stornoregeln und Nachbesetzung.",
            "tag": "Für Anbieter",
            "publish_date": date(2026, 7, 20),
            "reading_time": "5 Min",
        },
        {
            "slug": "2026-07-13-dsgvo-online-terminbuchung",
            "title": "DSGVO und Online-Terminbuchung",
            "description": "DSGVO und Online-Terminbuchung: Rechtsgrundlage, Datensparsamkeit und Checkliste.",
            "tag": "Für Anbieter",
            "publish_date": date(2026, 7, 13),
            "reading_time": "5 Min",
        },
        {
            "slug": "2026-07-06-terminmarktplatz-anbieter",
            "title": "So funktioniert Terminmarktplatz für Anbieter",
            "description": "Terminmarktplatz für Anbieter: Profil anlegen, Slots veröffentlichen, Buchungen managen.",
            "tag": "Für Anbieter",
            "publish_date": date(2026, 7, 6),
            "reading_time": "5 Min",
        },
        {
            "slug": "2026-06-29-wellness-spontan-buchen",
            "title": "Yoga, Coaching, Massage – spontan buchen",
            "description": "Yoga, Coaching und Massage spontan buchen: Drop-in und digitale Suche.",
            "tag": "Für Suchende",
            "publish_date": date(2026, 6, 29),
            "reading_time": "4 Min",
        },
        {
            "slug": "2026-06-22-handwerker-terminluecken",
            "title": "Terminlücken beim Handwerker: Was tun?",
            "description": "Terminlücken beim Handwerker füllen: Warteliste, Online-Slots und Planung.",
            "tag": "Für Anbieter",
            "publish_date": date(2026, 6, 22),
            "reading_time": "5 Min",
        },
        {
            "slug": "2026-06-15-last-minute-termine",
            "title": "Last-Minute Termine: Die besten Tipps",
            "description": "Last-Minute Termine finden: Die besten Tipps für digitale Suche und Buchung.",
            "tag": "Für Suchende",
            "publish_date": date(2026, 6, 15),
            "reading_time": "4 Min",
        },
        {
            "slug": "2026-06-08-therapeut-spontan",
            "title": "Spontan zum Therapeuten: Ist das möglich?",
            "description": "Spontan zum Therapeuten: Was bei Physio, Psychotherapie und Wellness realistisch ist.",
            "tag": "Für Suchende",
            "publish_date": date(2026, 6, 8),
            "reading_time": "4 Min",
        },
        {
            "slug": "2026-06-01-friseur-kurzfristig",
            "title": "Kurzfristig einen Friseur finden – so geht's",
            "description": "Friseur kurzfristig finden: Digitale Suche, Flexibilität und Wartelisten.",
            "tag": "Für Suchende",
            "publish_date": date(2026, 6, 1),
            "reading_time": "4 Min",
        },
        {
            "slug": "2026-05-25-stornierung-kosten",
            "title": "Was kostet eine Stornierung wirklich?",
            "description": "Stornierung Kosten Dienstleister: entgangener Umsatz, Leerlauf, Demotivation – mit konkreten Zahlen.",
            "tag": "Für Anbieter",
...
CHAT_KB: list[tuple[list[str], str]] = [
    ...
    (["storn", "stornier", "stornieren", "storno", "absag", "absagen", "termin aendern", "umbuch"],
    ...
    (["no show", "noshow", "nicht erschien", "nichterschein", "ausfallschutz", "kunde kommt nicht", "nicht aufgetaucht", "leerlauf"],
     "Gegen No-Shows (Nichterscheinen) kannst du als Anbieter eine optionale Anzahlung verlangen – sie läuft sicher über Stripe und dient als Ausfallschutz. Zusätzlich senken automatische Terminerinnerungen die Ausfallquote. Die Regeln legst du beim Erstellen eines Slots fest."),
    (["heute", "morgen", "sofort", "spontan", "same day", "noch heute", "ganz schnell"],
     "Genau dafür ist Terminmarktplatz da – kurzfristige und spontane Termine. In der Suche unter /suche kannst du nach Datum filtern und siehst freie Slots, oft schon für heute oder morgen."),
    (["benachrichtig", "alert", "bescheid", "frei wird", "verpasse", "informiert werden", "melden wenn", "terminwunsch"],
     "Ja: Du kannst dich benachrichtigen lassen, wenn passende Termine frei werden. Richte dazu einen Terminwunsch ein – wir informieren dich per E-Mail, sobald in deiner Nähe etwas Passendes verfügbar ist."),
    (["erinnerung", "erinner", "reminder", "whatsapp", "sms erinnerung", "nicht vergessen"],
     "Für gebuchte Termine erhältst du eine Bestätigung und – je nach Anbieter – zusätzliche Erinnerungen (z. B. per E-Mail oder WhatsApp), damit du deinen Termin nicht vergisst."),
    (["profil bearbeiten", "profil aendern", "profil anpassen", "logo", "oeffnungszeiten", "beschreibung aendern", "adresse aendern"],
     "Dein Anbieterprofil (Firmenname, Beschreibung, Logo, Öffnungszeiten usw.) bearbeitest du nach dem Login in deinem Portal. Änderungen sind jederzeit möglich und sofort sichtbar."),
    (["slot bearbeiten", "slot loeschen", "slot aendern", "slot entfernen", "termin bearbeiten", "angebot aendern", "termin entfernen"],
     "Deine eingestellten Slots kannst du im Anbieter-Portal jederzeit bearbeiten oder entfernen, solange sie noch nicht gebucht sind. Nach dem Login findest du sie in deiner Slot-Übersicht."),
    (["rechnung", "rechnungen", "beleg", "quittung", "invoice", "umsatzsteuer", "mwst"],
     "Deine Rechnungen für gebuchte Pakete findest du nach dem Login in deinem Konto. Fehlt eine Rechnung oder brauchst du sie angepasst, melde dich einfach über /kontakt."),
    (["kuendig", "abo beenden", "paket wechseln", "paket kuendigen", "upgrade", "downgrade", "paket aendern", "vertrag beenden"],
     "Pakete kannst du flexibel verwalten: Zum Wechseln oder Kündigen logge dich ein und öffne deine Konto- bzw. Paket-Einstellungen. Bei Fragen zur Abrechnung hilft dir /kontakt."),
    (["keine email", "email nicht", "keine mail", "bestaetigungsmail", "bestaetigung fehlt", "verifizier", "aktivierungslink", "link nicht erhalten", "spam"],
     "Keine Bestätigungs-E-Mail erhalten? Bitte schau auch im Spam-/Werbeordner nach – die Mail kommt direkt nach der Registrierung. Falls weiterhin nichts ankommt, melde dich über /kontakt, dann helfen wir dir bei der Aktivierung."),
    (["bewertung", "bewerten", "anbieter bewerten", "rezension", "sterne", "erfahrungen", "empfehlung"],
     "Bei der Auswahl helfen dir das Anbieterprofil und – sofern vorhanden – Bewertungen anderer Nutzer. Diese siehst du direkt beim jeweiligen Anbieter in der Suche unter /suche."),
    (["serioes", "serios", "betrug", "abzocke", "vertrauen", "vertrauenswuerdig", "fake"],
     "Terminmarktplatz ist ein seriöses Angebot mit Sitz und Hosting in Deutschland. Zahlungen laufen über den geprüften Dienst Stripe, und wir halten uns strikt an die DSGVO. Fällt dir etwas auf, informiere uns gern über /kontakt."),
    (["app", "handy", "smartphone", "mobil", "ios", "android", "download", "herunterladen"],
     "Eine eigene App brauchst du nicht: Terminmarktplatz läuft direkt im Browser und ist für Smartphones optimiert. Du kannst die Seite auf dem Handy öffnen und bei Bedarf zum Startbildschirm hinzufügen."),
    (["stadt", "staedte", "region", "umgebung", "in der naehe", "deutschlandweit", "verfuegbar in", "gibt es in"],
     "Terminmarktplatz ist deutschlandweit nutzbar. Wie viele Anbieter es gerade in deiner Nähe gibt, hängt von der Region ab – schau am besten direkt in der Suche unter /suche nach deinem Ort und deiner Branche."),
    (["wartezeit", "warteliste", "warten", "termin warten", "wie lange dauert", "reaktionszeit", "wann antwort"],
     "Viele Anbieter reagieren sehr kurzfristig, da Terminmarktplatz auf spontane Termine ausgelegt ist. Du buchst freie Slots direkt online und erhältst sofort eine Bestätigung – ohne Warteschleife am Telefon."),
]
